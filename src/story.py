...
class Story:
    ...
    def __init__(self, host, friend1, glmv):
        self.host = host
    ...
    def prologue(self):
        ...
        The ***REMOVED***hts festivities begin but you have a feeling to***REMOVED***ht's Physics Social will be very different from any other...".format(self.host, self.friend1))
